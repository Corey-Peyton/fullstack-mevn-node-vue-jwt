...
module.exports = function(app) {
    ...
    var controllerRegister = require('./controller/controller_register');
    var controllerLogin = require('./controller/controller_login');
    ...
    app.route('/login').post(controllerLogin.loginUser);
